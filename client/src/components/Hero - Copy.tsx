...
export default function Hero() {
  ...
  const videoData = [
    { video: `https://aispaces.in/creators/1.mp4`, text: "Gaga Showcase" },
    { video: `https://aispaces.in/creators/2.mp4`, text: "Creative Get Process" },
    { video: `https://aispaces.in/creators/3.mp4`, text: "Video Editing" },
    { video: `https://aispaces.in/creators/4.mp4`, text: "Master Programming" },
    { video: `https://aispaces.in/creators/5.mp4`, text: "Future AI" },
    { video: `https://aispaces.in/creators/6.mp4`, text: "Easy Scraping" },
  ];
          ...
          <div className="mx-auto max-w-4xl mt-5 text-center">
            ...
            >
              ...
              <span className="relative inline-block">
                {"d"}
                <FloatingIcon
                  icon="https://aispaces.in/creators/3zap.svg"
