...
const Hero = () => {
  ...
  // Optional lightweight parallax support (kept disabled on mobile)
  useEffect(() => {
    if (isMobile) return;
    const handleScroll = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" pt-20 sm:pt-24 md:pt-28 bg-transparent">
        ...
        {/* Top: compact centered copy (with space for header above) */}
        <div className="px-4 sm:px-6">
          <div className="mx-auto max-w-4xl text-center">
            {/* Headline (Line 1 & 2 merged into a single line) */}
            <div
              className="font-bold leading-tight opacity-0 animate-fade-in font-montserrat
                       text-xl sm:text-2xl md:text-2xl lg:text-3xl tracking-tight"
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <FloatingIcon
                  icon={lines}
                  containerClassName="
                  absolute -top-6 left-1/2 -translate-x-1/3 w-8 h-8
                  sm:-top-6 sm:w-10 sm:h-10
                  md:-top-8 md:w-12 md:h-12
                  lg:-top-8 lg:w-12 lg:h-12
                  xl:-top-12 xl:w-16 xl:h-16
                "
                  opacity={1}
                  zIndex={10}
                  enableRotation={true}
            ...
            <div className="relative">
              <div
                className="font-semibold text-primary leading-tight opacity-0 animate-fade-in font-nunito
                         text-sm sm:text-lg md:text-xl mt-3"
            ...
            <p
              ...
              className="section-subtitle leading-relaxed opacity-0 animate-fade-in text-muted-foreground
                       font-normal font-nunito text-sm sm:text-base md:text-lg
                       max-w-4xl mx-auto mt-3"
            >
              Creator Space is a 360° marketing agency that helps AI tools grow
              through influencer campaigns, community buzz, search visibility,
              and event amplification, all built by and for the AI community.
            </p>

            {/* Small pill CTA (constrained width to look smaller) */}
            <div
        ...
        {/* Bottom: curved gallery (lower portion) */}
        <div className="relative mx-auto -mt-1 w-full px-2 sm:px-4">
          ...
          <div
            ...
            aria-hidden="true"
          />
          {/* Gallery height tuned smaller to match reference */}
          <div className="relative w-full h-[50vh] sm:h-[46vh] md:h-[48vh] lg:h-[50vh]">
            <CircularGallery
              bend={0}
              textColor="#ffffff"
              borderRadius={0.08}
        ...
        {/* Subtle decorative icons (optional) */}
        <FloatingIcon
